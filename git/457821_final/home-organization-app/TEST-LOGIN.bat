@echo off
REM Test Login Auto-Flow
REM בדיקת תהליך כניסה אוטומטי

echo ========================================
echo  Test Login Auto-Flow
echo  בדיקת תהליך כניסה אוטומטי
echo ========================================
echo.
...
echo    [LoginPage] Sending login request...
echo    [LoginPage] Login successful!
echo    [LoginPage] Saving tokens to localStorage...
echo    [LoginPage] Token saved successfully
echo    [LoginPage] Redirecting to home page...
echo.
echo ========================================
...
echo   [OK] Success message: "התחברת בהצלחה!"
echo.
echo ========================================
echo  For detailed guide, see:
echo  למדריך מפורט, ראה:
echo ========================================
echo   LOGIN-AUTO-TEST.md
echo.
echo ========================================
echo  Note: If you don't have an account:
echo  הערה: אם אין לך חשבון:
echo ========================================
echo   Run: TEST-REGISTRATION.bat
echo   Or visit: http://localhost:5173/register
echo.
pause
